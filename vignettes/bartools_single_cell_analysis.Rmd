...
```{r}
plotCellsInClusters(test.sce, group = "Phase", factor = "G1", idents = "seurat_clusters")
```
...
```{r}
plotCellsInClusters(test.sce, group = "barcode", factor = "BC_12904", idents = "seurat_clusters")
```
