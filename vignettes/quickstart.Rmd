...
dge.cpmnorm <- normaliseCounts(dge.filtered.counts, method = "cpm", threshold = 1)
```
...
```{r}
plotBarcodeTimeseries(dge.filtered.collapsed[,dge.filtered.collapsed$samples$Treatment %in% c("Vehicle", "T0")], top = 10)
...
It is important to be able to determine which barcodes are most abundant wihtin each sample.
